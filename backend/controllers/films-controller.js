...
const mongoose = require('mongoose');
 async function connectDB () {
    try{
    await mongoose.connect('mongodb+srv://streambuddy:streambuddy@cluster0.fjc4h.mongodb.net/streambuddyDB?retryWrites=true&w=majority', { useNewUrlParser: true }, {useUnifiedTopology: true });
  } catch (error) {
    handleError(error);
  }
}
